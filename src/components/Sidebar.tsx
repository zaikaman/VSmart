...
const navItems = [
    ...
    { name: "VSmart AI", href: "/dashboard/ai", icon: Sparkles },
    { name: "Trò chuyện", href: "/dashboard/chat", icon: MessageCircle },
    { name: "Dự án mới", href: "/dashboard/projects/new", icon: PlusCircle },
